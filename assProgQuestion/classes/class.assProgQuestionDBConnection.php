...
class assProgQuestionDBConnection {
	...
	public static function saveAssProgQuestion($prog_question) {
		...
		// $affectedRows = $ilDB->manipulateF ( "INSERT INTO " . assProgQplQstProgQuest::TABLE_NAME . " (question_fi, solution, check_recursive, check_iterative, forbid_recursive, forbid_iterative, quest_type, test_code)" . " VALUES (%s, %s, %s, %s, %s, %s, %s, %s)", array (
		// 'integer',
		// 'text',
		// 'integer',
		// 'integer',
