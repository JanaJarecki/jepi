 ...
 *         
 */
class ilProgrammingTextAreaInputGUI extends ilTextAreaInputGUI {
	/**
	...
	function checkInput()
	{
		...
		else
		{
			...
			? ilUtil::stripSlashes($_POST[$this->getPostVar()], false, $allowed) // false - kein HTML entfernen
